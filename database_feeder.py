...
for portfolio_row in portfolio_df.itertuples():
    cur.execute("INSERT INTO portfolio (title, description, skills, image, code, blog_post, maj_date, tag, alt, latest) \
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                [portfolio_row.title, portfolio_row.description,
                 portfolio_row.skills, portfolio_row.image, portfolio_row.code,
                 portfolio_row.blog_post, portfolio_row.maj_date, portfolio_row.tag, portfolio_row.alt, portfolio_row.latest])
    conn.commit()
